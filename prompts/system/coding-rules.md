...
6. **Prohibited Patterns**:
   ...
   - Prompt assembly that omits the security rules for model-facing account workflows.
   - Passing passwords, cookies, OTP codes, or browser storage exports into models, logs, screenshots, or publisher adapters.
